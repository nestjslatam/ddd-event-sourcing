...
import { TransferInitiatedEvent, TransferCompletedEvent } from '../../domain/events/transfer.events';
...
export class AccountTransferSaga extends AbstractSaga {
     ...
     */
    @Saga()
    transferInitiationSaga$ = (events$: Observable<any>): Observable<ICommand> => {
        return events$.pipe(
