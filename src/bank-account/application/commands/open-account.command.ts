import { CommandHandler, ICommandHandler, ICommand, EventPublisher } from '@nestjs/cqrs';
...
export class OpenAccountCommandHandler implements ICommandHandler<OpenAccountCommand> {
    ...
    async execute(command: OpenAccountCommand): Promise<void> {
        ...
        const account = BankAccount.open(accountId, holderName, initialAmount, currency);
