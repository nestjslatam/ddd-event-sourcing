...
describe('BankAccountController', () => {
    ...
    describe('openAccount', () => {
        ...
        it('should throw BadRequestException if holderName is missing', async () => {
            ...
            await expect(controller.openAccount(dto)).rejects.toThrow(BadRequestException);
        });
        ...
        it('should throw BadRequestException if holderName is null', async () => {
            ...
            await expect(controller.openAccount(dto)).rejects.toThrow('Holder name is required');
        });
    });
    ...
    describe('withdraw', () => {
        ...
        it('should handle withdrawal errors from command bus', async () => {
            ...
            await expect(controller.withdraw('acc-789', dto)).rejects.toThrow('Insufficient funds');
        });
    });
    ...
    describe('getAccount', () => {
        it('should retrieve account by id', async () => {
            ...
            expect(queryBus.execute).toHaveBeenCalledWith(new GetAccountQuery('acc-123'));
        ...
        it('should throw NotFoundException if account does not exist', async () => {
            ...
            await expect(controller.getAccount('non-existent')).rejects.toThrow(NotFoundException);
