...
describe('InMemoryEventStore', () => {
    ...
    let deserializer: jest.Mocked<DomainEventDeserializer>;
    ...
    beforeEach(async () => {
        ...
        deserializer = module.get(DomainEventDeserializer) as jest.Mocked<DomainEventDeserializer>;
    });
    ...
    describe('persist', () => {
        ...
        it('should log persistence', async () => {
            ...
            expect(loggerSpy).toHaveBeenCalledWith('Persisted 1 events to InMemory store');
        });
    });
