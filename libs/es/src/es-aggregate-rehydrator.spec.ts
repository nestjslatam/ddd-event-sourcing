...
class TestAggregate extends DddAggregateRoot<TestAggregate, TestAggregateProps> {
...
describe('AggregateRehydrator', () => {
    ...
    beforeEach(async () => {
        ...
        snapshotStore = module.get(AbstractSnapshotStore) as jest.Mocked<AbstractSnapshotStore>;
    ...
    describe('rehydrate without snapshots', () => {
        ...
        it('should merge class context with event publisher', async () => {
            ...
            expect(eventPublisher.mergeClassContext).toHaveBeenCalledWith(TestAggregate);
        });
    ...
    describe('rehydrate with snapshots', () => {
        it('should rehydrate from snapshot and subsequent events', async () => {
            ...
            expect(snapshotStore.getLast).toHaveBeenCalledWith(aggregateId);
            expect(eventStore.getEventsByStreamId).toHaveBeenCalledWith(aggregateId, 2);
